...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '9da401b901ab4bd39f12bca0f9f2c463',
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || false, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  : process.env.NEXT_PUBLIC_ || 'heo', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '如雨初下', // 您的昵称 例如 tangly1024
  ...
  PRISM__PREFIX_PATH: process.env.NEXT_PUBLIC_PRISM__PREFIX_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/s/prism-okaidia.css', // 代码块默认主题
  PRISM__SWITCH: process.env.NEXT_PUBLIC_PRISM__SWITCH || true, // 是否开启浅色/深色模式代码主题切换； 开启后将显示以下两个主题
  PRISM__LIGHT_PATH: process.env.NEXT_PUBLIC_PRISM__LIGHT_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/s/prism-solarizedlight.css', // 浅色模式主题
  PRISM__DARK_PATH: process.env.NEXT_PUBLIC_PRISM__DARK_PATH || 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/s/prism-okaidia.min.css', // 深色模式主题
  ...
  WIDGET_PET_SWITCH_: process.env.NEXT_PUBLIC_WIDGET_PET_SWITCH_ || true, // 点击宠物挂件切换博客主题
